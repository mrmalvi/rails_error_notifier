...
require_relative "lib/rails_error_notifier/version"

Gem::Specification.new do |spec|
  spec.name = "rails_error_notifier"
  spec.version = RailsErrorNotifier::VERSION
  ...
  spec.add_dependency "twilio-ruby", "~> 6.6"
